...
- [Doc 5 Overview](mem://features/doc5-overview) — PvP sync fixes, 3D characters, sound assets, cinematics, performance
- [Player Card System](mem://features/player-card-system) — 5 rarity tiers, 6 stats, special abilities, upgrade system
- [Visual Theme](mem://style/visual-theme) — V1 Punchy Colors + 3D Chrome Depth system
- [Match Presentation](mem://features/match-presentation) — Cinematic ceremony system, stadium establishing shots
- [Commentary Content](mem://features/commentary-content) — 500+ lines across English, Hindi, Hinglish with clutch lines
- [Architecture/Engine System](mem://architecture/engine-system) — 8-engine reactive event-driven system
- [Navigation Structure](mem://ui/navigation-structure) — BottomNav with 5 tabs
- [App Structure](mem://architecture/app-structure) — Multi-page React SPA with Hub dashboard
- [Multiplayer Flow](mem://features/multiplayer-flow) — Real-time via Supabase Realtime, atomic RPCs
- [Game Scoring Rules](mem://game/scoring-rules) — Two-innings hand cricket format
- [Source of Truth](mem://project/source-of-truth) — Docs 1-5 guide development
...
- [Match Themes](mem://style/match-themes) — 10 environment themes
- [DRS Review](mem://game/drs-review) — 25% chance cinematic review on wickets
