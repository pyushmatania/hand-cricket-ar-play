...
const shotAnimations: Record<string, any> = {
  DEF: { rotate: [-2, 5, 0], transition: { duration: 0.4, ease: "easeOut" as const } },
  ...
  "4": { x: [0, 20, -5, 0], rotate: [0, 25, 30, 0], y: [0, -5, 0], transition: { duration: 0.9, ease: "easeOut" as const } },
  "6": { x: [0, 25, -10, 0], rotate: [0, -15, 45, 0], y: [0, -20, -25, 0], scale: [1, 1.1, 1.05, 1], transition: { duration: 1.2, ease: "easeOut" as const } },
  OUT: { rotate: [0, -5, 10, 5], y: [0, 2, 5, 8], opacity: [1, 1, 0.8, 0.5], transition: { duration: 1.0, ease: "easeIn" as const } },
};
