...
export default function FriendStatsModal({ friend, onClose, onChallenge }: Props) {
  ...
  useEffect(() => {
    ...
    const doLoad = async () => {
      ...
      if (myData) setMyProfile(myData as unknown as FriendProfile);
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <span className={`text-[8px] font-game-display font-bold ${friendTier.color}`}>{friendTier.emoji} {friendTier.name}</span>
